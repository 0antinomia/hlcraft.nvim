...
function M.render(instance)
  ...
  for line_nr, result_index in pairs(geometry.result_lines) do
    ...
    decorations.apply_color_cell(instance, instance.state.buf, line_nr - 1, fg_start, fg_text, result.fg, 'fg')
    decorations.apply_color_cell(instance, instance.state.buf, line_nr - 1, bg_start, bg_text, result.bg, 'bg')
    decorations.apply_color_cell(instance, instance.state.buf, line_nr - 1, sp_start, sp_text, result.sp, 'sp')
  end
