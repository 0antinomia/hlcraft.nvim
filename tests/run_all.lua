local tests = {
  ...
  'tests/dynamic_model_contract.lua',
  'tests/dynamic_model_normalization.lua',
  'tests/dynamic_model_compaction.lua',
  'tests/dynamic_effects.lua',
  'tests/dynamic_runtime.lua',
  'tests/ui_session.lua',
  'tests/ui_dynamic_editor.lua',
  'tests/ui_dynamic_preview.lua',
