...
h.assert_equal(color_context.fg, '#202020', 'color context fg did not use fallback value', scope)
h.assert_equal(color_context.bg, '#303030', 'color context bg did not use fallback value', scope)
h.assert_equal(color_context.sp, '#404040', 'color context sp did not use fallback value', scope)
h.assert_true(color_context.blend == nil, 'color context included a non-color field', scope)
...
local nil_context_result_ok = pcall(field_values.color_context, nil)
h.assert_true(not nil_context_result_ok, 'color context accepted nil result', scope)
