...
local bad_color_display_key_ok = pcall(session.display_color_value, 'clean', '', '#fallback')
h.assert_true(not bad_color_display_key_ok, 'session color display accepted empty field key', scope)
