...
h.assert_true(not nan_threshold_ok, 'color search accepted a non-finite threshold', scope)
local negative_threshold_ok = pcall(search.by_color, '#202020', -1)
h.assert_true(not negative_threshold_ok, 'color search accepted a negative threshold', scope)
